...
def create_table(dataset):
    ...
    for algorithm in algorithms:
        time_strs, r2_strs, rmse_strs = get_metrics_for_6_targets(df, dataset, algorithm)
    ...
    r2_df.to_csv(f"../final_results/{dataset}_r2.csv", index=False)
    rmse_df.to_csv(f"../final_results/{dataset}_rmse.csv", index=False)
