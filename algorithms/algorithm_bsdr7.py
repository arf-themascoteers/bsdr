...
from algorithms.bsdr7.bsdr7 import BSDR7
import numpy as np
from ds_manager import DSManager
import torch


class AlgorithmBSDR7(Algorithm):
    def __init__(self, target_size, splits, repeat, fold, structure=None, verbose=True, epochs=1000):
        ...
        self.bsdr = BSDR7(self.target_size, class_size, self.splits, self.get_name(), self.repeat, self.fold, [128,64], self.verbose, epochs)
