import torch
from algorithms.bsdr10.ann10 import ANN10
...
class BSDR10:
    def __init__(self, target_size, class_size, split, machine_name, repeat, fold, structure=None, verbose=True, epochs=2000):
        ...
        self.lr = 0.001
        self.model = ANN10(self.target_size, self.class_size, structure)
    ...
    def get_indices(self):
        indices = [int(torch.round(index).item()) for index in self.model.get_all_indices()*self.original_feature_size]
