...
from algorithms.bsdr11.linspacer11 import get_points


class ANN11(nn.Module):
    ...
    def get_group_loss(self):
        ...
        for i in range(self.target_size):
            start_index = i*self.group_size
            loss = loss + torch.std(self.indices[start_index:start_index+self.group_size])
        return loss
