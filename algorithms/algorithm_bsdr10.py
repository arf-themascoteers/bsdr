...
from algorithms.bsdr10.bsdr10 import BSDR10
import numpy as np
from ds_manager import DSManager
import torch


class AlgorithmBSDR10(Algorithm):
    def __init__(self, target_size, splits, repeat, fold, structure=None, verbose=True, epochs=4000):
        ...
        self.bsdr = BSDR10(self.target_size, class_size, self.splits, self.get_name(), self.repeat, self.fold, [64, 32], self.verbose, epochs)
