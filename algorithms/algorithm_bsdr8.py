...
from algorithms.bsdr8.bsdr8 import BSDR8
import numpy as np
from ds_manager import DSManager
import torch


class AlgorithmBSDR8(Algorithm):
    def __init__(self, target_size, splits, repeat, fold, structure=None, verbose=True, epochs=1000):
        ...
        self.bsdr = BSDR8(self.target_size, class_size, self.splits, self.get_name(), self.repeat, self.fold, [128,64], self.verbose, epochs)
